...
| **Proactive Notification Engine** | **Multithreaded HTTP API (Resend):** Auto-dispatches HTML briefings securely over port 443, bypassing SMTP firewalls. | **Passive Dashboard:** Requires users to log in to view charts. | **Passive Dashboard:** Users must actively search the map. | **Text-Only Mailing List:** Sends raw, unformatted text emails. |
...
| **System Thresholds & Limits** | **Batch Cap:** 50 articles/cycle.<br>**Email Limit:** 100/day (Resend API).<br>**NLP:** 2-hour pulse intervals. | **Scale Bound:** Limited by human typing speed and clinic connectivity. | **Scale Bound:** Millions of global articles, but lacks localized depth. | **Scale Bound:** Moderation queue creates severe backlog during pandemics. |
